...
public class CCBasica implements Search2 {
	...
	public CCBasica(AvaliaCoac coac, int tempo,double T0, double alpha, double beta,FabicaDeNovidade fn) {
	...
	public Node_LS run(GameState gs, int max, Node_LS j,Avaliador ava) throws Exception {
		...
		System.out.println("busca "+nov.m_a+" x "+nov.m_b+" "+ j.translate());
