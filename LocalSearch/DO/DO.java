...
public class DO implements Avaliador {
	...
	@Override
	public Pair<Double, Double> Avalia(GameState gs, int max, Node_LS j, Pair<Novidade, Novidade> oraculo)
			throws Exception {
		...
		double copia = oraculo.m_a.semelhaca(nov.m_a)+oraculo.m_b.semelhaca(nov.m_b);
